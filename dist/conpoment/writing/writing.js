...
var Write = /** @class */ (function () {
    ...
    Write.prototype.init = function () {
        var totlaCount = this.number / (this.width / 32) + 1;
        var i = 0;
        while (true) {
            if (i > totlaCount)
                break;
    ...
    Write.prototype.addRow = function () {
        return __awaiter(this, void 0, void 0, function () {
            var row, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        row = $("<div class=\"write-row\" style=\"width:" + this.width + "px\"></div>");
                        i = 0;
                        while (true) {
                            if (i > this.width / 32 - 1)
                                break;
                            row.append("<div class=\"write-item\"></div>");
                            i++;
                        }
                        return [4 /*yield*/, this.write.append(row)
